...
public class ZkClientFactoryBean implements FactoryBean<ZkClient>, InitializingBean, DisposableBean {
  ...
  private ZkSerializer serializer = new SimpleStringSerializer();
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    if (null != zkConnection) {
      ...
      throw new IllegalArgumentException("Either zkConnection or ensemble must be provided to create a ZkClient instance.");
    }
